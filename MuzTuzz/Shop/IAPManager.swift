...
extension IAPManager.IAPManagerError: LocalizedError {
    var errorDescription: String? {
        switch self {
        case .noProductIDsFound: return "Не найдены ID товаров."
        case .noProductsFound: return "К сожалению товары не найдены."
        case .productRequestFailed: return "К сожалению невозможно загрузить товары в данный момент."
        case .paymentWasCancelled: return "Покупка была отменена."
        }
    }
}
